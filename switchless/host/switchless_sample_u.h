 ...
 */
#ifndef EDGER8R_SWITCHLESS_SAMPLE_U_H
#define EDGER8R_SWITCHLESS_SAMPLE_U_H

#include <openenclave/host.h>

#include "switchless_sample_args.h"

OE_EXTERNC_BEGIN

oe_result_t oe_create_switchless_sample_enclave(
    const char* path,
...
oe_result_t enclave_decrement_switchless(
    oe_enclave_t* enclave,
    int* m);

oe_result_t enclave_decrement_regular(
    oe_enclave_t* enclave,
    int* m);
...
#endif // EDGER8R_SWITCHLESS_SAMPLE_U_H
