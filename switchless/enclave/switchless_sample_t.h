 ...
 */
#ifndef EDGER8R_SWITCHLESS_SAMPLE_T_H
#define EDGER8R_SWITCHLESS_SAMPLE_T_H
...
void enclave_decrement_switchless(int* m);

void enclave_decrement_regular(int* m);
...
#endif // EDGER8R_SWITCHLESS_SAMPLE_T_H
